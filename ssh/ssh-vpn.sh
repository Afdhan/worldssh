...
organizationalunit=WORLDSSH.COM
...
#wget https://worldssh.com/api/sc/latest/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
cd /usr/bin
# menu
# wget -O menu "https://worldssh.com/api/sc/latest/menu/menu.sh"
# wget -O m-vmess "https://worldssh.com/api/sc/latest/menu/m-vmess.sh"
# wget -O m-vless "https://worldssh.com/api/sc/latest/menu/m-vless.sh"
# wget -O running "https://worldssh.com/api/sc/latest/menu/running.sh"
# wget -O clearcache "https://worldssh.com/api/sc/latest/menu/clearcache.sh"
# wget -O m-ssws "https://worldssh.com/api/sc/latest/menu/m-ssws.sh"
# wget -O m-trojan "https://worldssh.com/api/sc/latest/menu/m-trojan.sh"
...
# change port
#wget -O port-ssl "https://worldssh.com/api/sc/latest/port/port-ssl.sh"
#wget -O port-ovpn "https://worldssh.com/api/sc/latest/port/port-ovpn.sh"
